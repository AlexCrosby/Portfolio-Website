...
const Projects = () => {
    ...
    const sketcher = {
        ...
        body: (<div><p>Sketcher is a pictionary-esque game created as part of a group project for the University of Birmingham Computer Science Msc.</p>
            <p>It  allows multiple people to connect to a server in which multiple games are hosted. When a game is in
                ...
                Players are scored on correct guesses, and the highest scorer after a number of rounds is the winner.</p>
            <p>Sketcher is built primarily in Java, using JavaFX for the GUI. It contains three main components: The
                ...
                logic, and communication between clients;  and a database which stores login details and lifetime player scores.</p>
            </div>)
    }
